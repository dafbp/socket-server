...
export default function Market() {
    ...
    useEffect(() => {
        ...
        socketAPI.subcribeCall(reqInfo)
        handleMarketData()
        return () => {};
    }, []);

    const handleMarketData = () => {
        glb_sv.eventMarket.subscribe(( resMsg:ISubMrkMsg ) => {
            if (resMsg.type === MARKET_EVENT.update_data) {
                glb_sv.marketData = resMsg.msg.data;
                console.log("eventMarket", resMsg.msg)
